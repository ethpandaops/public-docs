...
<Tabs className="data-tabs">
    <TabItem value="available-data" label="Available Data">
        ...
        <MDImporter url="https://raw.githubusercontent.com/ethpandaops/xatu-data/master/README.docusaurus.md" />
    ...
    <TabItem value="working-with-the-data" label="Working with the data">
    ...
    <TabItem value="contribute-to-xatu-data" label="Contribute to Xatu data">
...
<div className="license-separator"></div>

<div className="data-footer">
  <div className="license-container">
    <div className="license-item mit">
      <span className="license-label">Xatu code:</span>
      <a target="_blank" href="https://github.com/ethpandaops/xatu-data/blob/master/LICENSE" className="license-link">MIT License</a>
    </div>
    <div className="license-item cc">
      <span className="license-label">Xatu data:</span>
      <a href="https://creativecommons.org/licenses/by/4.0/deed.en" target="_blank" rel="license noopener noreferrer" className="license-link">
        CC BY 4.0
        <img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1" alt="CC" className="cc-icon" />
        <img src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1" alt="BY" className="cc-icon" />
      </a>
    </div>
  </div>
</div>